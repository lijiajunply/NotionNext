...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LuckyFish', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个写代码的', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.luckyfishes.site', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,luckyfishes', // 网站关键词 英文逗号隔开
